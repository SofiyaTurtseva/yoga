...
const handleVideos = videos.bind(null, isBuild, browserSyncInstance);
...
function watcher() {
	...
	gulp.watch(filePaths.watch.videos, handleVideos);
}
 ...
 * */
const devTasks = gulp.parallel(copy, copyRootFiles, /*createSvgSprite,*/ handleHTML, handleSCSS, handleJS, handleImages, handleVideos);
